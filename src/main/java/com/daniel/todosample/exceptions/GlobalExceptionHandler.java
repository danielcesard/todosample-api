package com.daniel.todosample.exceptions;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler implements AuthenticationFailureHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(
        ...
        ErrorResponse errorResponse = new ErrorResponse(
            ...
            "Validadtion error. Check 'errors' field for details.");
    ...
    public ResponseEntity<Object> handleDataIntegrityViolationException(
        ...
        log.error("Failed to save entity with integrity problms: " + errorMessage, dataIntegrityViolationException);
    ...
    public ResponseEntity<Object> handleConstraintViolationException(
        ...
        log.error("Filed to validade element", constraintViolationException);
    ...
    public ResponseEntity<Object> ObjectNotFoundException(
        ...
        log.error("Filed to find the requested element", objectNotFoundException);
    ...
    public ResponseEntity<Object> DataBindingViolationException(
        ...
        log.error("Filed to save the entity with associated data", dataBindingViolationException);
